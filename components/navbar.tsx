    ...
    <header className="sticky top-0 z-20 border-b border-[#262626] bg-[#111111]/95 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 sm:px-6">
        ...
        <div className="ml-auto flex items-center gap-3">
          <div className="hidden items-center rounded-full border border-[#2d2d2d] bg-[#1a1a1a] px-3 py-1.5 sm:flex">
            <input
              placeholder="Search"
              className="w-28 bg-transparent text-sm outline-none placeholder:text-gray-500"
            />
            <span className="rounded-full bg-[#ff6a00] px-2 py-0.5 text-xs">Q</span>
          </div>
